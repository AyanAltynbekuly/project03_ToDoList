...
const handleReturn =(id)=>{
  ...
  return (
    <div className="App">
      ...
      <header>
        ...
        <div style={{position:'relative'}}>
          <button onClick={handleTriggerModal} className="add-btn"> <img src={plus} alt="add-btn"/></button>
    ...
    <div class="dropdown">
  <button class="dropbtn"><img src={selectImg} alt="dropbtn"/></button>
  <div class="dropdown-content">
    <a href="/#" onClick={()=>handleItemTrash(item.id)}> <img src={trashImg} alt="trashImg"/>   Move To Trash</a>
    <a href="/#"onClick={()=>handleDelete(item.id)} > <img src={trashImg} alt="deleteImg"/>  Delete Forever</a>
    <a href="/#" onClick={()=>handleReturn(item.id)}><img src={returnImg} alt="returnImg"/>  Return To To Do</a>
